...
QFont KNFontDialog::getFont(const QFont &defaultFont)
{
    ...
    //Launch the dialog.
    return (fontDialog->exec()==QDialog::Accepted)?
                fontDialog->currentFont():defaultFont;
}
...
void KNFontDialog::fontChanged(const int &currentIndex)
{
...
void KNFontDialog::sizeChanged(const int &currentSize)
{
