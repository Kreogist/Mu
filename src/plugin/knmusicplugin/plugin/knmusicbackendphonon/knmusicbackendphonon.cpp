...
{
    //Set the main and preview thread.
...
int KNMusicBackendPhonon::minimalVolume() const
{
    return 0;
}

int KNMusicBackendPhonon::maximumVolume() const
{
    return 10000;
}

void KNMusicBackendPhonon::setGlobalVolume(const int &volume)
{
