...
/*!
 * \brief The KNMusicSearcher class is the specific music file searcher. The
 * suffix list has been set to music suffix only.
 */
...
public:
    /*!
     * \brief Construct a KNMusicSearcher object.
