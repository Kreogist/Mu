 ...
 */
#ifndef KNMUSICWPLPARSER_H
#define KNMUSICWPLPARSER_H

#include "../../sdk/knmusicplaylistparser.h"

class KNMusicWPLParser : public KNMusicPlaylistParser
{
    Q_OBJECT
public:
    explicit KNMusicWPLParser(QObject *parent = 0);
